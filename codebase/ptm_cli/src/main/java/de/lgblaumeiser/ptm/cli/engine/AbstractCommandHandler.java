...
/**
 * An abstract base class with the central handleCommand method and some common
 * resources needed by many handlers
 */
public abstract class AbstractCommandHandler {
	...
	protected static PrettyPrinter getPrinter() {
		return printer;
	}

	public static void setPrinter(final PrettyPrinter printer) {
		AbstractCommandHandler.printer = printer;
	}
