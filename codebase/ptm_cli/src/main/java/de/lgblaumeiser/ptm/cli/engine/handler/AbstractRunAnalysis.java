...
abstract class AbstractRunAnalysis extends AbstractCommandHandler {
	protected void runAnalysis(final String command, final YearMonth month, final LocalDate week, final LocalDate day) {
	...
	private String parseTimeFrame(final YearMonth month, final LocalDate week, final LocalDate day) {
		if (day != null) {
	...
	private String extractTimeFrameType(final YearMonth month, final LocalDate week, final LocalDate day) {
		if (day != null) {
			return "day";
		}
		if (week != null) {
