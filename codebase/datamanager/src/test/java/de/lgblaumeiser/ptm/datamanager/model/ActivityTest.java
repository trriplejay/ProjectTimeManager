...
public class ActivityTest {
	...
	/**
	 * Negative test method for a line activity with a known booking number but other category
	 */
	...
	/**
	 * Negative test method for a project activity with a known booking number but other category
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Negative test method for a line activity with an activity although type does not take activities
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Negative test method for a project activity with an activity although type does not take activities
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Negative test method for a line activity without an activity although type needs activities
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Negative test method for a project activity without an activity although type needs activities
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	public final void testEquals() {
		Activity newActivity1 = Activity.newLineActivity(LINE_ACTIVITY_1_1, LINE_CATEGORY_1, LINE_BOOKING_1);
		Activity newActivity2 = Activity.newLineActivity(LINE_ACTIVITY_1_2, LINE_CATEGORY_1, LINE_BOOKING_1);
		Activity newActivity3 = Activity.newProjectActivity(PROJECT_ACTIVITY_1_1, PROJECT_CATEGORY_1, PROJECT_BOOKING_1);
