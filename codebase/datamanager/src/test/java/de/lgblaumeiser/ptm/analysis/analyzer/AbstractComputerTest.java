...
public abstract class AbstractComputerTest {
	...
	private static final Activity ACTIVITY1 = Activity.newActivity(ACTIVITYNAME1, BOOKINGNUMBER1);
	private static final Activity ACTIVITY2 = Activity.newActivity(ACTIVITYNAME2, BOOKINGNUMBER2);
	private static final Activity ACTIVITY3 = Activity.newActivity(ACTIVITYNAME3, BOOKINGNUMBER1);
	...
	private static final Booking BOOKING8 = Booking.newBooking().setStarttime(TIME7).setEndtime(TIME8)
			.setActivity(ACTIVITY2).build();
	private static final Booking BOOKING9 = Booking.newBooking().setStarttime(TIME4).setActivity(ACTIVITY3).build();
