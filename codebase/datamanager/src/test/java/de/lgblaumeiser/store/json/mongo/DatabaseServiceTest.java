...
public class DatabaseServiceTest {
    ...
    //
    // private static final Activity ACTIVITY1 =
    // Activity.newLineActivity("Act1", "0815");

    // private static final Booking BOOKING1 =
    // Booking.newBooking().setStarttime(TIME1).setEndtime(TIME2)
    // .setActivity(ACTIVITY1).build();
    //
    // private static final Booking BOOKING2 =
    // Booking.newBooking().setStarttime(TIME2).setEndtime(TIME3)
    // .setActivity(ACTIVITY1).build();
    //
